...
function DrinksIng (){
    ...
    useEffect(()=> {
        // if DrinksIn is null , undefined , {} or ...
        (async()=>{
            ...
            // console.log will print the data for test . and function setDrinksIn will take the value of the drinks from object beacuse drinks date are inside a object valuer
        })();
    },[]);
    return (
        <>
